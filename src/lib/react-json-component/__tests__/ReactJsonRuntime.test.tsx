/**
 * ReactJsonRuntime.test.tsx
 *
 * Tests for the framework-agnostic React JSON runtime.
 */


import { describe, it, expect } from 'vitest';
import { render, screen, fireEvent } from '@testing-library/react';
import { ReactJsonRuntime } from '../react/ReactJsonRuntime';
...
function renderTemplate(
  ...
  options: Parameters<typeof ReactJsonRuntime>[0]['options'] = {},
) {
  return render(
    <ReactJsonRuntime template={template} options={options} />,
  );
}
...
describe('ReactJsonRuntime', () => {
  ...
  it('has the correct displayName', () => {
    expect(ReactJsonRuntime.displayName).toBe('ReactJsonRuntime');
  });
});
